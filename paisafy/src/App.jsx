...
function App() {
  ...
  return (
    ...
    >
      ...
      className="bg-white/18 backdrop-blur-md p-6 sm:p-8 rounded-2xl shadow-xl w-full max-w-xl text-white"
      >
        ...
        <form
          ...
          <div>
            <label className="block font-medium">Amount to Invest (₹)</label>
            <input
              type="number"
              name="amountToInvest"
          ...
          <div className="md:col-span-2">
            <label className="block font-medium">Time Frame (in years)</label>
            <input
              type="number"
              name="horizon"
