        ...
        <div className="flex flex-col md:flex-row items-center justify-between md:gap-12">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left mb-12 md:mb-0">
            ...
            <p className="text-lg md:text-xl text-opacity-80 mb-8 max-w-2xl mx-auto md:mx-0">
              Get personalized investment advice tailored to your financial
              goals, risk tolerance, and market conditions. Discover the best
              stocks, ETFs, and SIPs for your portfolio.
            </p>
            ...
            <div className="mt-16 flex flex-col md:flex-row justify-center md:justify-start space-y-8 md:space-y-0 md:space-x-8">
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm.707-10.293a1 1 0 00-1.414-1.414L7.586 9H5a1 1 0 000 2h.414L7.586 12.414a1 1 0 001.414-1.414L10 9.586l.293-.293z"
                    clipRule="evenodd"
                  ></path>
                </svg>
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707a1 1 0 00-1.414-1.414L10 9.586l-1.293-1.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 10.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293z"
                    clipRule="evenodd"
                  ></path>
                </svg>
